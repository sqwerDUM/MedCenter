...
public class Update extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (month.equals("Янв")) {
            mm.setSelection(0);
        } else if (month.equals("Фев")) {
            mm.setSelection(1);
        } else if (month.equals("Мар")) {
            mm.setSelection(2);
        } else if (month.equals("Апр")) {
            mm.setSelection(3);
        } else if (month.equals("Май")) {
            mm.setSelection(4);
        } else if (month.equals("Июн")) {
            mm.setSelection(5);
        } else if (month.equals("Июл")) {
            mm.setSelection(6);
        } else if (month.equals("Авг")) {
            mm.setSelection(7);
        } else if (month.equals("Сен")) {
            mm.setSelection(8);
        } else if (month.equals("Окт")) {
            mm.setSelection(9);
        } else if (month.equals("Ноя")) {
            mm.setSelection(10);
        } else {
            mm.setSelection(11);
        }
        ...
        if (tmp.equals("Пациент")) {
            usertype.setSelection(0);
        } else if (tmp.equals("Доктор")) {
            usertype.setSelection(1);
        } else if (tmp.equals("Сотрудник")) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fnames.equals("") || lnames.equals("") || ages.equals("") || dds.equals("") ||
                    ...
                    Message.message(Update.this, "Пожалуйста, заполните все ваши данные");
                } else {
                    ...
                    if (b) {
                        Message.message(Update.this, "Информация о пользователе успешно обновлена");
                        finish();
                    } else {
                        Message.message(Update.this, "При Обновлении произошла ошибка");
                    }
                }
            }
        });
