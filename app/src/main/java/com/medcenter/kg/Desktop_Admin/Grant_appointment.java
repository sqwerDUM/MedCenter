...
public class
Grant_appointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (y.moveToFirst()) {
            while (true) {
                ...
                //приложение pateinet approvl поддерживает три режима: W - ожидание, A - одобрено, F - завершено
            ...
            Message.message(Grant_appointment.this, "Никаких отложенных заявок");
            finish();
        }
        ...
        lv_appointment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (y) {
                    Message.message(Grant_appointment.this, "Заявка одобрена");
                    finish();
                } else {
                    Message.message(Grant_appointment.this, "Не одобрено");
                }
            }
        });
    }
