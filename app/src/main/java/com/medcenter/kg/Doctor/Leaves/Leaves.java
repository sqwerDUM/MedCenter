package com.medcenter.kg.Doctor.Leaves;
        ...
        switch (v.getId()) {
            ...
            default:
                ...
                if (ds1.equals("") || ds2.equals("") || ys1.equals("") || ys2.equals("")) {
                    Message.message(Leaves.this, "Пожалуйста, заполните все ваши данные");
                } else {
                    //ПРОВЕРЬТЕ, СУЩЕСТВУЮТ ЛИ ДУБЛИКАТЫ ИЛИ НЕТ
                    if (ds1.length() == 1)
                        ds1 = "0" + ds1;
                    ...
                    if (b) {
                        Message.message(Leaves.this, "Отправленная заявка");
                    } else {
                        Message.message(Leaves.this, "Это заявление уже отправлено");
                    }
                    dbh.close();
                }
        }
