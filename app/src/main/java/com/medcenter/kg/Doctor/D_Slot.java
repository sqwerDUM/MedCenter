...
public class D_Slot extends AppCompatActivity {
    ...
    public void onClick(View view) {
        ...
        if (y.moveToFirst()) {
            ...
            if (b) {
                Message.message(D_Slot.this, "Ваш слот был обновлен");
            } else {
                Message.message(D_Slot.this, "Произошла какая-то ошибка, повторите попытку");
            }
        } else {
            boolean b = db.insert_slot(username, password, "", s, e, "Y");
            if (b) {
                Message.message(D_Slot.this, "Ваш слот был вставлен");
            } else {
                Message.message(D_Slot.this, "Произошла какая-то ошибка, повторите попытку");
            }
        }
