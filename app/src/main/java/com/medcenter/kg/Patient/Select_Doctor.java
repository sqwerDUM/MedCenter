        ...
        if (y.moveToFirst()) {
            ...
            if (y.getString(5).equals("Y")) {
                ...
                if (s_doctors.size() > 0) {
                    ...
                    Message.message(Select_Doctor.this, "К сожалению, у вас нет специализации");
                }
            } else {
                Message.message(Select_Doctor.this, "К сожалению, врача сейчас нет на месте");
            }
        }


        //На элементе нажать на прослушиватель для врачей
